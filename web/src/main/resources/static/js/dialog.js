var Modal = (function ($) {
    var BackDrop = (function () {
        ...
        getTpl = function () {
            return ['<div class="modal fade" data-backdrop="false" data-show="false" data-keyboard="false">',
                    ...
                    '</div><div class="modal-body text-center" style="font-size: 16px;"></div>',
    ...
    ModalDialog.defaults = {
        ...
        buttons: [
            {
                html: '<button type="button" class="btn btn-primary btn-ok">确定</button>',
                selector: '.btn-ok',
                callback: getDefaultBtnCallbackProxy('onOk')
            },
            {
                html: '<button type="button" class="btn btn-default btn-cancel">取消</button>',
                selector: '.btn-cancel',
